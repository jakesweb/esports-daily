...
})(["label{font-size:1.2em;font-weight:600;font-style:italic;color:#010101;display:block;}textarea{display:block;}input[type=\"text\"],textarea{width:50em;}#tags{margin:0 auto;margin-bottom:2em;display:block;}textarea{margin:0 auto;}input[type=\"text\"],textarea{border:5px yellow solid;border-radius:10px;}button{padding-top:0.8em;font-size:1.5em;font-weight:600;font-style:italic;background:yellow;border:2px black solid;border-radius:10px;}"]);
...
//# sourceMappingURL=submit.js.71564916041ce8b99c2f.hot-update.js.map