...
})(["overflow:hidden;background-color:yellow;padding-bottom:10%;.meta,:not(.MuiChip-root){text-align:center;margin:5%;margin-bottom:0;line-height:20%;.title{font-size:1.4em;font-weight:600;}}.markdown{padding:5%;padding-bottom:0;}"]);
    ...
    value: function render() {
      return __jsx(react_apollo__WEBPACK_IMPORTED_MODULE_10__["Query"], {
        ...
        return __jsx(StyledDiv, {
          ...
          __self: this
        }, "Submitted", " ", new Date(post.createdAt).toLocaleDateString("en-US")), post.tags.map(function (tag, i) {
...
//# sourceMappingURL=[id].js.beb48e7696ce091678d6.hot-update.js.map