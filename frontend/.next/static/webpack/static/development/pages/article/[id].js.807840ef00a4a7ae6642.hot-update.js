...
})(["overflow:hidden;background-color:yellow;padding-bottom:10%;.meta{text-align:center;margin:5%;margin-bottom:0;line-height:20%;.title{font-size:1.4em;font-weight:600;}}.chips{margin:0 auto;width:60%;text-align:center;display:flex;flex-direction:row;flex-wrap:wrap;div{margin:10px;}span{min-height:20px;min-width:80px;font-size:2em;}}.markdown{padding:5%;padding-bottom:0;}"]);
...
//# sourceMappingURL=[id].js.807840ef00a4a7ae6642.hot-update.js.map