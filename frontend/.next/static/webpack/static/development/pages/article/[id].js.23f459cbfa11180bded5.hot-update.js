...
})(["overflow:hidden;background-color:yellow;padding-bottom:10%;.meta{text-align:center;margin:5%;margin-bottom:0;line-height:20%;.title{font-size:1.4em;font-weight:600;}}.chips{margin:5px auto;text-align:center;display:flex;flex-direction:column;width:50%;position:relative;div{margin-right:10px;}}.markdown{padding:5%;padding-bottom:0;}"]);
...
//# sourceMappingURL=[id].js.23f459cbfa11180bded5.hot-update.js.map