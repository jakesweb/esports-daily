...
})(["overflow:hidden;background-color:yellow;padding-bottom:10%;.meta{text-align:center;margin:5%;margin-bottom:0;line-height:20%;.title{font-size:1.4em;font-weight:600;}}.chips{margin:5px auto;text-align:center;display:flex;flex-direction:row;flex-wrap:wrap;width:50%;div{margin-right:10px;}span{min-height:20px;min-width:80px;font-size:2em;}}.markdown{padding:5%;padding-bottom:0;}"]);
...
//# sourceMappingURL=[id].js.549e5ad8c96eb2607bf7.hot-update.js.map