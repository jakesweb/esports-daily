...
})(["overflow:hidden;background-color:yellow;padding-bottom:10%;.meta{text-align:center;margin:5%;margin-bottom:0;line-height:20%;.title{font-size:1.4em;font-weight:600;}}.markdown{margin-bottom:8%;padding:5%;}"]);
    ...
    value: function render() {
      return __jsx(react_apollo__WEBPACK_IMPORTED_MODULE_10__["Query"], {
        ...
        return __jsx(StyledDiv, {
          ...
          __self: this
        }, "Submitted", " ", new Date(post.createdAt).toLocaleDateString("en-US")), __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_12__["Divider"], {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 58
          },
...
//# sourceMappingURL=[id].js.c9203ad5d756a2a1a5f4.hot-update.js.map