...
})(["overflow:hidden;background-color:yellow;padding-bottom:10%;.meta{text-align:center;margin:5%;margin-bottom:0;line-height:20%;.title{font-size:1.4em;font-weight:600;}}.chips{margin:5px auto;text-align:center;flex:4;display:flex;width:50%;overflow:auto;div{display:flex;min-height:max-content;margin-right:10px;}}.markdown{padding:5%;padding-bottom:0;}"]);
...
//# sourceMappingURL=[id].js.ea4fdda6c36b5f047d83.hot-update.js.map