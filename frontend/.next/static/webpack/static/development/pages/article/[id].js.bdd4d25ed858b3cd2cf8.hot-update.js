    ...
    value: function render() {
      return __jsx(react_apollo__WEBPACK_IMPORTED_MODULE_10__["Query"], {
        ...
        return __jsx(StyledDiv, {
          ...
          __self: this
        }, "Submitted", " ", new Date(post.createdAt).toLocaleDateString("en-US")), post.tags.forEach(function (tag) {
          __jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_12__["Chip"], {
            label: tag,
            __source: {
              fileName: _jsxFileName,
              lineNumber: 61
...
//# sourceMappingURL=[id].js.bdd4d25ed858b3cd2cf8.hot-update.js.map