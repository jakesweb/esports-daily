...
})(["overflow:hidden;background-color:yellow;padding-bottom:10%;.meta{text-align:center;margin:5%;margin-bottom:0;line-height:20%;.title{font-size:1.4em;font-weight:600;}}.chips{margin:5px auto;text-align:center;display:flex;flex:4;width:50%;div{margin-right:10px;}}.markdown{padding:5%;padding-bottom:0;}"]);
...
//# sourceMappingURL=[id].js.797fb1cc2bf88cc5170c.hot-update.js.map